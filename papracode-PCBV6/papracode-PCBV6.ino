...
// Pin connections per PAPR V0.6 PCB
// PA0 - UPDI/RESET
// PA1 - ADC - FUSE-ILM
...
int buzzerPin   = PIN_PB1; 
int powerGood   = PIN_PB3; // Active high when power is good
...
void setup() {
  ...
  Serial.println("PAPRA 25AUGUST2021");
  Serial.println("PCB v0.6");
