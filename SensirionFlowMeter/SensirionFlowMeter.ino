...
#include <Time.h>
#include "SSD1306Wire.h" //  Arduino library "ESP8266 and ESP32 Oled Driver for SSD1306 display"
...
const int skipCount = 50;  //adjust to speed up or slow down serial display updates
